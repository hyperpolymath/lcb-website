...
We keep a concrete Cerro Torre manifest at `infra/wordpress.ctp`. It imports the Debian Hardened Image, overlays the Sinople theme plus php-aegis helpers, copies `.well-known` assets, and emits the signed OCI bundle that Vörðr executes.
