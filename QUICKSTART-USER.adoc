...
// Replace lcb-website, Lcb Website — See README.adoc for details., just run, Lcb Website started successfully. with actuals
= lcb-website — Quick Start for Users
:toc:
:toclevels: 2

== What is lcb-website?

Lcb Website — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./lcb-website-portable
----
...
[source]
----
Lcb Website started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/lcb-website/wiki
