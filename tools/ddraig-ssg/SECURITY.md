...
Replace all {{PLACEHOLDER}} values with your information:
  Lcb Website     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  lcb-website             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/lcb-website/security/advisories/new)
...
- This repository (`hyperpolymath/lcb-website`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/lcb-website/security/advisories)
...
When using Lcb Website, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/lcb-website/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/lcb-website/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/lcb-website/discussions) |
...
*Thank you for helping keep Lcb Website and its users safe.* 🛡️
